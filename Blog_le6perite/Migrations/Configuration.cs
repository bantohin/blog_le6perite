        ...
        protected override void Seed(ApplicationDbContext context)
        {
            if (!context.Users.Any())
            {
                ...
                CreatePost(context,
                    ...
                    body: @"<p>Rogue Wave is updating its open-source framework for developing Web applications and services. According to the company, this is the first major release in four years. 
